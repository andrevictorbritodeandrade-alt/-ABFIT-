...
export function WorkoutFeed({ history, onBack, onToggleMenu, isProfessor = false }: { history: WorkoutHistoryEntry[], onBack: () => void, onToggleMenu?: () => void, isProfessor?: boolean }) {
  return (
